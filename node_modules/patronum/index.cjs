module.exports.and = require('./and/index.cjs').and;
...
module.exports.either = require('./either/index.cjs').either;
module.exports.empty = require('./empty/index.cjs').empty;
module.exports.equals = require('./equals/index.cjs').equals;
...
module.exports.not = require('./not/index.cjs').not;
module.exports.once = require('./once/index.cjs').once;
module.exports.or = require('./or/index.cjs').or;
module.exports.pending = require('./pending/index.cjs').pending;
module.exports.previous = require('./previous/index.cjs').previous;
module.exports.readonly = require('./readonly/index.cjs').readonly;
