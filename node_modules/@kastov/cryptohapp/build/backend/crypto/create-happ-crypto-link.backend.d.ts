 ...
 * ```
 */
export declare function createHappCryptoLink(content: string, version: HappCryptoVersion, asLink: true): string | null;
/**
 * Creates a Happ crypto deep link by encrypting content with RSA public key.
 * Uses Node.js native `crypto.publicEncrypt()` for backend.
 ...
 * ```
 */
export declare function createHappCryptoLink(content: string, version: HappCryptoVersion, asLink?: false): HappCryptoResult | null;
//# sourceMappingURL=create-happ-crypto-link.backend.d.ts.map